...
*/
VVS_Car = ["B_Quadbike_01_F","B_Truck_01_covered_F","B_G_Offroad_01_F"];
VVS_Air = ["B_Heli_Light_01_F","B_Heli_Transport_01_F","O_Heli_Light_02_unarmed_F"];
VVS_Ship = [""];
VVS_Armored = ["B_MRAP_01_F","B_MRAP_01_hmg_F","O_MRAP_02_F","O_MRAP_02_hmg_F","I_MRAP_03_F","I_MRAP_03_hmg_F"];
VVS_Submarine = [""];
VVS_Autonomous = [""];
VVS_Support = [""];
