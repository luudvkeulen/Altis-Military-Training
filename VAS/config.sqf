...
vas_customslots = 5; //14 is actually 15 slots, starts from 0 to whatever you set, so always remember when setting a number to minus by 1, i.e 12 will be 11.
...
vas_weapons = ["arifle_MXM_F","arifle_MX_SW_F","srifle_EBR_F","SMG_01_F","LMG_Mk200_F"];
//Want to limit VAS to specific magazines? Place the classnames in the array!
vas_magazines = ["30Rnd_45ACP_Mag_SMG_01","30Rnd_65x39_caseless_mag","100Rnd_65x39_caseless_mag","20Rnd_762x51_Mag","200Rnd_65x39_cased_Box"];
//Want to limit VAS to specific items? Place the classnames in the array!
vas_items = ["muzzle_snds_H","muzzle_snds_B","muzzle_snds_H_MG","optic_Arco","optic_Hamr","optic_Holosight_smg","muzzle_snds_acp"];
